      ...
      try {
         ...
         if (profile) {
            ...
            profile.jenis_kelamin =
               reqBody.jenis_kelamin || profile.jenis_kelamin;
            ...
            profile.nomor_telepon =
               reqBody.nomor_telepon || profile.nomor_telepon;
            ...
            profile.pekerjaan_ibu =
               reqBody.pekerjaan_ibu || profile.pekerjaan_ibu;
            profile.posisi = reqBody.posisi || profile.posisi;
            profile.status = Boolean(reqBody.status) || profile.status;
            profile.tanggal_bergabung =
               reqBody.tanggal_bergabung || profile.tanggal_bergabung;
            profile.tanggal_lahir =
               reqBody.tanggal_lahir || profile.tanggal_lahir;
